...
**Method:** Static review of architecture docs, security notes, key runtime paths (`main.js`, merge layer, mod collectors), Jest suite inventory, `npm audit`, and cross-reference with existing audits ([_internal/AUDIT_v3.9_PREFINAL.md](./_internal/AUDIT_v3.9_PREFINAL.md), [_internal/AUDIT_v3.0.md](./_internal/AUDIT_v3.0.md)).
...
2. **DOM XSS surface** not uniformly escaped across every module — pastures path hardened; other modules may still need the same discipline ([_internal/AUDIT_v3.9_PREFINAL.md](./_internal/AUDIT_v3.9_PREFINAL.md) follow-up).
...
Use **[_internal/RELEASE_READINESS_v3.9.md](./_internal/RELEASE_READINESS_v3.9.md)** as the operator checklist and **[_internal/UPDATER_QA.md](./_internal/UPDATER_QA.md)** for behaviour validation.
...
- [_internal/RELEASE_READINESS_v3.9.md](./_internal/RELEASE_READINESS_v3.9.md)
- [_internal/archive-releases/RELEASE_v3.9.0.md](./_internal/archive-releases/RELEASE_v3.9.0.md)
- [_internal/AUDIT_v3.9_PREFINAL.md](./_internal/AUDIT_v3.9_PREFINAL.md)
