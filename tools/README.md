...
| Path | Purpose |
|------|---------|
| [**app/**](./app/) | Electron **npm** helpers (run from `FS25_FarmDashboard_App/FS25_FarmDashboard_App/`): `run-electron-builder.mjs`, `electron-builder-fresh-output.mjs`, **`verify-electron-pack-files.mjs`** (`npm run verify:electron-pack`), `parity.js`, field CSV export, install-lock / clean-build **PowerShell**. |
