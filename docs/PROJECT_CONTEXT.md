...
- **Field guidance:** **Offline rules** on field cards + optional Lua **`suggestions`** list from the mod — no remote model or subscription service in this tree’s **4.0.0** baseline.
