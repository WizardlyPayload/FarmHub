...
**Documentation:** [docs/README.md](docs/README.md) (index) · **Simple install:** [INSTALL.md](INSTALL.md) · **Product description + screenshot checklist:** [docs/DESCRIPTION_AND_SCREENSHOTS.md](docs/DESCRIPTION_AND_SCREENSHOTS.md) · **Security & LAN access:** [docs/SECURITY.md](docs/SECURITY.md) · **AI Farm Manager — Gemini key/model routing:** [docs/LLM_GEMINI_ROUTING.md](docs/LLM_GEMINI_ROUTING.md) · **Developer handover (full stack):** [DEVELOPER_HANDOVER.md](DEVELOPER_HANDOVER.md) · **Release blurbs + doc map:** [RELEASE_NOTES.md](RELEASE_NOTES.md) · **Authors:** [AUTHORS.md](AUTHORS.md)
