...
**Historical document:** This file describes the **v3.0.0** release line. For **current** app and mod versions, see **[GITHUB_RELEASE_v4.0.0.md](./GITHUB_RELEASE_v4.0.0.md)** and **[CHANGELOG.md](./CHANGELOG.md)** §**3.9.0**.
