...
Long-form narrative: [_internal/archive-releases/RELEASE_v3.9.0.md](./_internal/archive-releases/RELEASE_v3.9.0.md).
...
3. Attach **`latest.yml`** and the **`.exe`** from the build output, plus **`FS25_FarmDashboard.zip`** for the FS25 mod (see **`tools\Zip-FarmDashboardMod.ps1`** and [GITHUB_RELEASE_v4.0.0.md](./GITHUB_RELEASE_v4.0.0.md) “Attach to this release”).
...
Follow **[_internal/UPDATER_QA.md](./_internal/UPDATER_QA.md)** end-to-end.
...
- Promote **v4.0.0** narrative and user-facing notes ([CHANGELOG.md](./CHANGELOG.md), [GITHUB_RELEASE_v4.0.0.md](./GITHUB_RELEASE_v4.0.0.md)).
...
| Doc | Purpose |
| --- | ------- |
| [_internal/UPDATER_QA.md](./_internal/UPDATER_QA.md) | Behaviour matrix for electron-updater |
| [_internal/archive-releases/RELEASE_v3.9.0.md](./_internal/archive-releases/RELEASE_v3.9.0.md) | What shipped in 3.9.0 |
| [_internal/AUDIT_v3.9_PREFINAL.md](./_internal/AUDIT_v3.9_PREFINAL.md) | Prefinal audit record |
