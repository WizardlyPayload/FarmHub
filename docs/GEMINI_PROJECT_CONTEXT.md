...
- **Field guidance:** **Offline rules** on field cards + optional Lua **`suggestions`** list — **no** bundled remote model or subscription service in this tree’s **3.0.0** documentation baseline.
...
| `web/assests/js/rules-engine.js` | Offline suggestions |
