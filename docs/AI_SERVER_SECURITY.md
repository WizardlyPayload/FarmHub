...
- Unchanged: `**X-FarmDash-Key`**, `**server_token**`, and subscription tiers behave as documented in [DEVELOPER_HANDOVER.md](./DEVELOPER_HANDOVER.md) and [AI_FARM_MANAGER_BYOK.md](./AI_FARM_MANAGER_BYOK.md).
...
Further Gemini-specific behaviour: [LLM_GEMINI_ROUTING.md](./LLM_GEMINI_ROUTING.md). OpenAI cloud and **OpenAI-compatible** (Ollama/LAN) env and headers: [LLM_OPENAI_COMPATIBLE.md](./LLM_OPENAI_COMPATIBLE.md).