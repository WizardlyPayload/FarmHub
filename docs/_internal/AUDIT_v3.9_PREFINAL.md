...
Blockers **#1–#3** below have been addressed in code + docs; **manual updater QA** (3.9.0 → 4.0.0) remains the final gate per **[_internal/UPDATER_QA.md](./_internal/UPDATER_QA.md)**.
