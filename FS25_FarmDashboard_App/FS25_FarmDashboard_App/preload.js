...
contextBridge.exposeInMainWorld('farmDashAPI', {
    ...
    getAiSuggestionSettings: () => ipcRenderer.invoke('get-ai-suggestion-settings'),
    saveAiSuggestionSettings: (payload) => ipcRenderer.invoke('save-ai-suggestion-settings', payload),
    testHostedAiConnection: (payload) => ipcRenderer.invoke('test-hosted-ai-connection', payload),
