...
| [RELEASE_v4.0.0.md](./RELEASE_v4.0.0.md) | Long-form **4.0.0** stable narrative |
...
| [**DEVELOPER_HANDOVER.md**](./DEVELOPER_HANDOVER.md) | **Dev reference:** architecture, mod, Electron host, merge, rules, i18n, build, debugging |
...
| [**RELEASE_READINESS_v3.9.md**](./RELEASE_READINESS_v3.9.md) | **Operator checklist:** 3.9 ship + updater rehearsal (historical; see **RELEASE_v4.0.0.md** for 4.0 publish) |
